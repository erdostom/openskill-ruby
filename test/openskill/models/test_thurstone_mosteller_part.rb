...
module OpenSkill
  module Models
    class TestThurstoneMostellerPart < Minitest::Test
      def setup
        @model = ThurstoneMostellerPart.new
        @fixture_path = File.expand_path('../../fixtures/thurstone_mosteller_part.json', __dir__)
      ...
      def test_model_defaults
        ...
        assert_in_delta 0.1, @model.epsilon, 0.0001
      ...
      def test_calculate_ratings_basic
        ...
        model = ThurstoneMostellerPart.new(mu: mu, sigma: sigma)
