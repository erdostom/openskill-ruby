...
module OpenSkill
  module Models
    class TestBradleyTerryFull < Minitest::Test
      def setup
        @model = BradleyTerryFull.new
        @fixture_path = File.expand_path('../../fixtures/bradley_terry_full.json', __dir__)
      ...
      def test_calculate_ratings_basic
        ...
        model = BradleyTerryFull.new(mu: mu, sigma: sigma)
